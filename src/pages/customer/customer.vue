    ...
    <view>
        ...
        >
            <view class="bg-white" :class="navShow ? 'nav' : ''">
                <uni-search-bar placeholder="搜索" radius="50" @confirm="search">
                </uni-search-bar>
            </view>
                ...
                >
                    <view v-for="(item, index) in items" :key="index">
                        ...
                        >
                            ...
                            <template slot="footer" @tap.stop="expand(item.id)">
                                <view v-if="item.expanded" class="fa fa-chevron-up"></view>
                                <view v-else class="fa fa-chevron-down"></view>
                            </template>
                        </t-list-item>
