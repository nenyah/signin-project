...
export default {
    post: (url: string, data: any, base_url = '', hideLoading = false) => {
        return fetch({url, method: 'POST', data, base_url, hideLoading})
    },
    get: (url: string, data: any, base_url = '', hideLoading = false) => {
        return fetch({url, method: 'GET', data, base_url, hideLoading})
    },
    upload: (
        url: string,
        filePath: string,
